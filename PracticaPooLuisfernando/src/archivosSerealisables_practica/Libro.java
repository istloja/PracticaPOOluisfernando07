...
public class Libro implements Serializable {
    ...
    public void escribirLibro(String Direccion, List<Libro> lj) {
        try {
            ObjectOutputStream escritor = new ObjectOutputStream(new FileOutputStream(Direccion));
            List<Libro> lc;
            for (Libro libro : lj) {//para crear una lista
                escritor.writeObject(libro);
            }
            escritor.close();
        } catch (Exception e) {
    ...
    public void leerArchivo(String Direccion) {
        try {
            ...
            System.out.println("el libro se llama se llama: " + libro.getAutor() + " " + libro.getAutor());
        } catch (Exception e) {
            System.out.println("se produjo un error " + e);
        }
    }
    ...
    public List<Libro> leerLibro(String dire) {
        List<Libro> lj = new ArrayList<>();//creamos la lista para guardar objetos
        try {
   ...
   int edadmenor = lj.get(0).getAño_de_publicacion();
    ...
    public static void main(String[] args) {
       Libro objeto = new Libro();
        Libro l1 = new Libro("las 7 maravillas del mundo ", new Autor("Pablo", "Ramon", 45, 967234672, 23, "loja"), 34, 123, 2000);
        Libro l2 = new Libro("la emancipada", new Autor("Diego", "Ordoñez", 34, 875699083, 26, "Malacatos"), 38, 165, 2005);
        Libro l3 = new Libro("don quijote de la mancha", new Autor("Fabian", "Valverde", 50, 95234589, 27, "Cuenca"), 39, 154, 2010);
     ...
     for (Libro libro : lj){
        ...
        objeto.escribirLibro("C:\\Users\\ISTLOJA1\\Desktop\\lista.txt", lj);
objeto.leerArchivo("C:\\Users\\ISTLOJA1\\Desktop\\lista.txt");

        objeto.escribirObjeto("C:\\Users\\ISTLOJA1\\Desktop\\lista.txt", l4);
        List<Libro> b = objeto.leerLibro("C:\\Users\\ISTLOJA1\\Desktop\\lista.txt");
        for (Libro libro : b) {
            System.out.println(libro.getNumeropaginas());
        }
        System.out.println("el libro mas antiguo es"+objeto.edadMenor(lj));
